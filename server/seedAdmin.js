...
const seedAdmin = async () => {
  ...
  if (admin) {
    console.log('Admin user already exists. Updating role to super-admin and resetting password to 123...');
    admin.role = 'super-admin';
    admin.isAdmin = true;
    admin.password = '123';
    admin.twoFactorEnabled = false; // Reset 2FA so user can log in
    await admin.save();
