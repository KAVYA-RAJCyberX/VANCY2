      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between py-8 border-b border-gray-100 mb-8">
          ...
          <div className="flex items-center gap-4 mt-6 md:mt-0">
            <button className="flex items-center gap-2 text-sm font-medium tracking-wider uppercase border border-gray-200 px-4 py-2 hover:bg-black hover:text-white transition-colors">
