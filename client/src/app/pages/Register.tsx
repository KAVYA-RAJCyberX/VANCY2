    ...
    <div className="pt-32 pb-24 min-h-screen bg-[#F5F1E8] flex items-center justify-center">
      <div className="max-w-md w-full px-4 sm:px-6">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-black font-['Playfair_Display'] tracking-[0.2em] uppercase mb-4 text-[#3B121A]">Register</h1>
          <p className="text-[#0A0A0A] font-medium text-sm">Create an account for faster checkout.</p>
        </div>
        ...
        <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div>
              <input 
                ...
                {...register("name")}
                className={`w-full border-b-2 py-3 px-0 focus:outline-none transition-colors bg-transparent text-sm ${errors.name ? 'border-red-500 placeholder-red-300' : 'border-[#0A0A0A] focus:border-[#C9A961] placeholder-[#0A0A0A]/60'}`}
              />
          ...
          <div>
              <input 
                ...
                className={`w-full border-b-2 py-3 px-0 focus:outline-none transition-colors bg-transparent text-sm ${errors.confirmPassword ? 'border-red-500 placeholder-red-300' : 'border-[#0A0A0A] focus:border-[#C9A961] placeholder-[#0A0A0A]/60'}`}
              />
        ...
        <div className="mt-12 text-center text-sm text-[#0A0A0A] font-bold tracking-widest uppercase">
          <p>Already have an account? <Link to="/login" className="text-[#C9A961] hover:text-[#0A0A0A] transition-colors ml-1">Sign In</Link></p>
        </div>
